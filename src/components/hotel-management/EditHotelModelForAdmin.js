...
export const EditHotelModelForAdmin = ({
  hotel,
  isOpen,
  onClose,
  isUpdating,
  ...
  const handleLocationChange = (coords) => {
    onUpdate({ ...hotel, latitude: coords.lat, longitude: coords.lng }, false);
  };

  const handleSubmit = (e) => {
    e.preventDefault();
    onUpdate(hotel, true); // true indicates trigger API call
  };
        ...
        <div className="p-6 bg-base-100 h-full max-h-[90vh] overflow-y-auto">
          <div className="flex items-center justify-between mb-6">
            <h3 className="font-bold text-lg flex items-center gap-2">
              <Settings2 size={20} className="text-primary" /> Edit Hotel
              Details
            </h3>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control col-span-2">
                ...
                <input
                  ...
                  value={hotel.name || ""}
                  onChange={(e) =>
                    onUpdate({ ...hotel, name: e.target.value }, false)
                  }
                  required
                />
              </div>
              <div className="form-control col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    onUpdate({ ...hotel, description: e.target.value }, false)
                  }
                />
              </div>
              <div className="form-control">
                ...
                <input
                  ...
                  value={hotel.address || ""}
                  onChange={(e) =>
                    onUpdate({ ...hotel, address: e.target.value }, false)
                  }
                  required
                />
              </div>
              <div className="form-control">
                ...
                <input
                  ...
                  value={hotel.city || ""}
                  onChange={(e) =>
                    onUpdate({ ...hotel, city: e.target.value }, false)
                  }
                  required
                />
              </div>
              <div className="form-control">
                ...
                <select
                  ...
                  value={hotel.priceUnit}
                  onChange={(e) =>
                    onUpdate({ ...hotel, priceUnit: e.target.value }, false)
                  }
                >
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdate(
                      { ...hotel, price: parseFloat(e.target.value) },
                      false,
                    )
                  }
                  required
              ...
              <div className="form-control">
                ...
                <input
                  type="number"
                  className="input input-bordered w-full"
                  value={hotel.discount || 0}
                  onChange={(e) =>
                    onUpdate(
                      { ...hotel, discount: parseFloat(e.target.value) },
                      false,
                    )
                  }
                />
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdate({ ...hotel, imageUrl: e.target.value }, false)
                  }
                />
              </div>
            </div>
            ...
            <div className="form-control">
              <label className="label-text text-[10px] font-bold mb-2 opacity-50 uppercase flex items-center gap-2">
                <MapPin size={14} /> Hotel Location (Sri Lanka)
              </label>
              <MapSelector
                lat={hotel.latitude}
                lng={hotel.longitude}
            ...
            <div className="form-control">
              <label className="label cursor-pointer justify-start gap-4 p-0">
                <input
                  ...
                  checked={hotel.featured || false}
                  onChange={(e) =>
                    onUpdate({ ...hotel, featured: e.target.checked }, false)
                  }
                />
