...
export const CameraStatusChnageModel = ({
  camera,
  isOpen,
  onClose,
  isUpdating,
      ...
      <div className="modal-box max-w-sm rounded-3xl">
        ...
        <div className="flex items-center gap-3 p-4 bg-base-200/30 rounded-2xl mb-6 border border-dashed border-base-300">
          ...
          <div className="truncate text-left">
            <p className="font-bold text-sm truncate">{camera.name}</p>
        ...
        <div className="form-control">
          ...
          <select
            ...
            value={camera.status || ""}
            onChange={(e) =>
              onUpdate({ ...camera, status: e.target.value }, false)
            }
          >
